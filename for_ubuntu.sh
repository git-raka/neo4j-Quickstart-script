...
wget https://neo4j.com/artifact.php?name=neo4j-enterprise-4.4.12-unix.tar.gz -q --show-progress

cp 'artifact.php?name=neo4j-enterprise-4.4.12-unix.tar.gz'  neo4j-enterprise-4.4.12-unix.tar.gz && rm 'artifact.php?name=neo4j-enterprise-4.4.12-unix.tar.gz'
tar -xvf neo4j-enterprise-4.4.12-unix.tar.gz

var=$(pwd)
echo "The current working directory $var"

#define filename
cd $var/neo4j-enterprise-4.4.12/conf
filename='neo4j.conf'
...
neo4j.bloom.license_file=/home/mri/neo4j-enterprise-4.4.12/licenses/bloom.txt
gds.enterprise.license_file=/home/mri/neo4j-enterprise-4.4.12/licenses/gds.txt
...
# add plugin
cd $var/neo4j-enterprise-4.4.12/plugins
